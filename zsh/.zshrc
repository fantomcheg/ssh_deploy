...
## Broot
# Repo-managed shell integration for broot.
# Avoid sourcing the autogenerated launcher because it may conflict
# with the custom function below and can hang during setup on some systems.
